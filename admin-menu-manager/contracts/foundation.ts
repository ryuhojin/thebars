...
export const foundationRoutes: FoundationRoute[] = [
  ...
  { path: "/bars/{barId}/orders", label: "테이블 목록", area: "operations", auth: "protected", status: "implemented" },
  { path: "/bars/{barId}/orders/new", label: "테이블 생성", area: "operations", auth: "protected", status: "implemented" },
  { path: "/bars/{barId}/orders/{orderTabId}", label: "테이블 상세", area: "operations", auth: "protected", status: "implemented" },
