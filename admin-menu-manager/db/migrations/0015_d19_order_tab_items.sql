...
CREATE TABLE order_tab_events_d19_new (
  id TEXT PRIMARY KEY,
...
INSERT INTO order_tab_events_d19_new (
  id,
  bar_id,
  order_tab_id,
  event_type,
...
ALTER TABLE order_tab_events_d19_new RENAME TO order_tab_events;
...
CREATE TABLE order_tab_items (
  id TEXT PRIMARY KEY,
  bar_id TEXT NOT NULL REFERENCES bars(id) ON DELETE CASCADE,
  order_tab_id TEXT NOT NULL REFERENCES order_tabs(id) ON DELETE CASCADE,
  item_type TEXT NOT NULL CHECK (item_type IN ('menu')),
...
CREATE TABLE idempotency_keys (
  ...
  operation TEXT NOT NULL CHECK (operation IN ('order_item_add')),
